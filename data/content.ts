...
/* ── shared shapes ── */
export interface Card { title: string; body: string; slug?: string }
...
const ar: Dict = {
  ...
  protection: {
    ...
    topics: [
      { title: 'كيف تتحقق قبل الاستثمار؟', body: 'خطوات أساسية للتأكد من جدية أي جهة قبل إيداع أموالك.', slug: 'كيف-تتحقق-قبل-الاستثمار' },
      { title: 'علامات المنصات غير الموثوقة', body: 'مؤشرات تكشف المنصات المشبوهة قبل الوقوع في فخها.', slug: 'علامات-المنصات-غير-الموثوقة' },
      { title: 'حماية بياناتك المالية', body: 'كيف تحافظ على سرية معلوماتك وحساباتك.', slug: 'حماية-بياناتك-المالية' },
      { title: 'مخاطر الوعود المضمونة', body: 'لماذا تُعد ضمانات الأرباح علامة إنذار مبكرة.', slug: 'مخاطر-الوعود-المضمونة' },
      { title: 'كيف تتصرف عند الاشتباه؟', body: 'ما الذي يجب فعله فور ظهور أي إشارة مقلقة.', slug: 'كيف-تتصرف-عند-الاشتباه' },
    ],
  },
  alerts: {
    ...
    topics: [
      { title: 'رسوم السحب الوهمية', body: 'طلب رسوم إضافية قبل السماح بسحب الأرباح.', slug: 'رسوم-السحب-الوهمية' },
      { title: 'انتحال هوية الشركات', body: 'استخدام أسماء وشعارات جهات معروفة لخداع الضحايا.', slug: 'انتحال-هوية-الشركات' },
      { title: 'الاحتيال عبر تطبيقات التواصل', body: 'عروض واستثمارات مغرية تصل عبر الرسائل الخاصة.', slug: 'الاحتيال-عبر-تطبيقات-التواصل' },
      { title: 'الروابط الاحتيالية', body: 'روابط تهدف إلى سرقة بياناتك أو بيانات دخولك.', slug: 'الروابط-الاحتيالية' },
      { title: 'المحافظ الرقمية المزيفة', body: 'محافظ ومنصات مقلّدة لاستدراج الإيداعات.', slug: 'المحافظ-الرقمية-المزيفة' },
    ],
  },
  reports: {
    title: 'تقارير توعوية',
    ...
    topics: [
      { title: 'الاحتيال في التداول', body: 'أنماط الخداع المنتشرة في منصات التداول.', slug: 'الاحتيال-في-التداول' },
      { title: 'الاحتيال في العملات الرقمية', body: 'مخاطر مرتبطة بالأصول الرقمية والعملات المشفرة.', slug: 'الاحتيال-في-العملات-الرقمية' },
      { title: 'التوعية المالية في الخليج', body: 'واقع الوعي المالي واحتياجاته في المنطقة.', slug: 'التوعية-المالية-في-الخليج' },
      { title: 'الأمن الرقمي', body: 'أساسيات حماية الأجهزة والحسابات والبيانات.', slug: 'الأمن-الرقمي' },
      { title: 'سلوكيات المحتالين', body: 'كيف يبني المحتال الثقة قبل تنفيذ الاحتيال.', slug: 'سلوكيات-المحتالين' },
    ],
  },
  resources: {
    title: 'موارد للجمهور',
    ...
    topics: [
      { title: 'قائمة تحقق قبل الاستثمار', body: 'نقاط تراجعها قبل اتخاذ أي قرار مالي.', slug: 'قائمة-تحقق-قبل-الاستثمار' },
      { title: 'دليل حفظ الأدلة', body: 'كيف توثّق تعاملاتك ومحادثاتك بشكل سليم.', slug: 'دليل-حفظ-الأدلة' },
      { title: 'دليل حماية المحافظ الرقمية', body: 'خطوات لتأمين محافظك وحساباتك الرقمية.', slug: 'دليل-حماية-المحافظ-الرقمية' },
      { title: 'دليل التحقق من الشركات', body: 'كيف تتحقق من جدية وترخيص أي جهة.', slug: 'دليل-التحقق-من-الشركات' },
      { title: 'دليل التعامل مع الطلبات المشبوهة', body: 'ماذا تفعل عند تلقّي طلب مالي غير مبرر.', slug: 'دليل-التعامل-مع-الطلبات-المشبوهة' },
    ],
  },
  contact: {
    title: 'تواصل معنا',
