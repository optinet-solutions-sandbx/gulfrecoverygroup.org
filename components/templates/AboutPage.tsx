    ...
    <div dir={isRTL ? 'rtl' : 'ltr'} style={{ fontFamily: font }}>
      ...
      <section style={{ background: '#fff', padding: '64px 0 40px' }}>
        <div className="wrap" style={{ maxWidth: 820 }}>
          <p className="reveal" style={{ margin: 0, fontSize: 'clamp(1.05rem,1.7vw,1.2rem)', lineHeight: 1.95, color: 'var(--ink)' }}>{a.body}</p>
        </div>
      </section>
      ...
      <section style={{ background: '#fff', padding: '20px 0 64px' }}>
        <div className="wrap grid-2">
          <div className="reveal" style={{ background: 'var(--navy)', color: '#fff', borderRadius: 14, padding: '32px 30px' }}>
            <div style={{ display: 'inline-flex', width: 46, height: 46, borderRadius: 10, background: 'rgba(79,211,156,0.15)', alignItems: 'center', justifyContent: 'center', marginBottom: 18 }}>
              <Target size={22} style={{ color: '#7fe3b6' }} aria-hidden />
            </div>
          ...
          <div className="reveal" style={{ background: 'var(--panel)', border: '1px solid var(--line)', borderRadius: 14, padding: '32px 30px', animationDelay: revealDelay(0.1) }}>
            <div style={{ display: 'inline-flex', width: 46, height: 46, borderRadius: 10, background: 'var(--official-50)', border: '1px solid #cbe6d9', alignItems: 'center', justifyContent: 'center', marginBottom: 18 }}>
              <Eye size={22} style={{ color: 'var(--official)' }} aria-hidden />
            </div>
      ...
      <section style={{ background: 'var(--panel-2)', borderTop: '1px solid var(--line)', padding: '64px 0' }}>
        <div className="wrap">
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, justifyContent: 'center' }}>
            {a.values.map((v, i) => (
              <span key={v} className="reveal" style={{
                ...
                <CheckCircle2 size={17} style={{ color: 'var(--official)' }} aria-hidden />{v}
              </span>
            ))}
          </div>
        </div>
